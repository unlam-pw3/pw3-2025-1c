    ...
    public class RegaloServicio : IRegaloServicio
    {
        ...
        public RegaloServicio()
        {
            if (_regalos == null)
            {
                ...
                _regalos.Add(new Regalo { Descripcion = "Flores", Precio = 100, Imagen = "/imagenes/flores.jpg" });
                _regalos.Add(new Regalo { Descripcion = "Chocolates", Precio = 200, Imagen = "/imagenes/Chocolates.jpg" });
                _regalos.Add(new Regalo { Descripcion = "Peluche", Precio = 300, Imagen = "/imagenes/Peluche.jpg" });
            }
